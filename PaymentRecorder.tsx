...
export const PaymentRecorder: React.FC<PaymentRecorderProps> = ({ payment, onSubmit, onCancel }) => {
  const [amountPaid, setAmountPaid] = useState(payment.amountDue + payment.penalty);
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-sm border-t pt-2">
              ...
              <span className="font-bold text-lg">₱{(payment.amountDue + payment.penalty).toLocaleString()}</span>
            </div>
          </div>
        </div>
